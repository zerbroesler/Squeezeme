...
function Create(game, model, tool) {
	...
	return function() {
		...
		game.add.button(100,100,'vertical', function() {
			model.setBrush(new Phaser.Rectangle(0, 0, c.playField.xSize / 4, c.playField.ySize / 1.3));
		}, this);
		game.add.button(100,233,'horizontal', function() {
			model.setBrush(new Phaser.Rectangle(0, 0, c.playField.xSize / 1.3, c.playField.ySize /4));
		}, this);
